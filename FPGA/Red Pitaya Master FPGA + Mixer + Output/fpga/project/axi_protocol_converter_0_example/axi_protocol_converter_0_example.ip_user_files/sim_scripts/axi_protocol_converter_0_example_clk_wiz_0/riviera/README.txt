...
#
# Generated by export_simulation on Mon Aug 08 10:28:11 +0100 2016
#
################################################################################
...
./axi_protocol_converter_0_example_clk_wiz_0.sh
...
switch to the './axi_protocol_converter_0_example_clk_wiz_0.sh' script.

./axi_protocol_converter_0_example_clk_wiz_0.sh -reset_run
...
./axi_protocol_converter_0_example_clk_wiz_0.sh -noclean_files

For more information on the script, please type './axi_protocol_converter_0_example_clk_wiz_0.sh -help'.
