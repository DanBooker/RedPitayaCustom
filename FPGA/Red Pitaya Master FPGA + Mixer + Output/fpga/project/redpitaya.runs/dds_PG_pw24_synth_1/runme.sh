...
HD_PWD='C:/Users/RazBB/Documents/GitHub/RedPitayaMaster/fpga/project/redpitaya.runs/dds_PG_pw24_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_PG_pw24.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dds_PG_pw24.tcl
